package com.xiiv.springcloud.common.service.impl;

import com.xiiv.springcloud.common.pojo.*;
import com.xiiv.springcloud.common.repository.CommonRepository;
import com.xiiv.springcloud.common.service.CommonService;
import com.xiiv.springcloud.common.util.FastCopy;
import com.xiiv.springcloud.common.util.UUIDUtil;
...
//        Page<E> page = commonRepository.findAll(Example.of(FastCopy.copy(entityVo, entityClass)), pageCondition.getPageable());
        Page<E> page = commonRepository.findAll(pageCondition.getPageable());
