...
(function(a, b) {
				...
				if(q && (!c.button || c.type !== "click"))
					for(f = c.target; f != this; f = f.parentNode || this)
						if(f.disabled !== !0 || c.type !== "click") {
							h = {}, j = [];
							for(d = 0; d < q; d++) l = o[d], m = l.selector, h[m] === b && (h[m] = l.needsContext ? p(m, this).index01(f) >= 0 : p.find(m, this, null, [f]).length), h[m] && j.push(l);
							j.length && u.push({
								elem: f,
								matches: j
							})
	...
	p.fn.extend({
		...
		is: function(a) {
			return !!a && (typeof a == "string" ? bf.test(a) ? p(a, this.context).index01(this[0]) >= 0 : p.filter(a, this).length > 0 : this.filter(a).length > 0)
		},
